	...
	return (
		<FadeInSection id="about" className="mb-24 scroll-mt-24" aria-label="About me">
			...
			<div className="text-[var(--ui-muted)] space-y-4">
				...
				<p>
					Most recently, I worked on <span className="text-[var(--accent)] font-medium"><a href="https://www.youtube.com/watch?v=bpp20D8_zQE" target="_blank" rel="noopener noreferrer" 
        aria-label="Link to youtube video of State of Decay 3 trailer"
        title="State of Decay 3 Trailer">State of Decay 3</a></span> building the UI players interact with constantly. Menus, inventory, HUD. The kind of work where getting it wrong means frustration, and getting it right means no one notices at all. 
				</p>
				<p>
